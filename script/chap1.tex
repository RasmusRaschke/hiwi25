...
.\end{align*} Assume that the hypersurface restricing the motion of the ball in $q^3$-direction is given by an implicit equation \[
f(q^1(t), q^2(t))=q^3(t)

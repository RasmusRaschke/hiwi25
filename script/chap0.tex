...
\end{theorem}
It is noteworthy that this is really not a covering in the sense of topological spaces: The Euler angle map has singularities at which $\mathfrak{E}$ fails to be a local homeomorphism. This is called \emph{gimbal lock}. With this, we are ready to tackle the full three-dimensional magnetic system.
